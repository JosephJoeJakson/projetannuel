      ...
      <div className="hero-section__overlay">
        <div className="hero-section__content">
          <h1 className="hero-section__headline">
            <span className="hero-section__line">Des créations</span><br />
            <span className="hero-section__line hero-section__words-wrapper">
              {WORDS.map((word, idx) => (
                <b
                  key={word}
            ...
            <span className="hero-section__line">crochetées et</span><br />
            <span className="hero-section__line">gravées</span>
          </h1>
